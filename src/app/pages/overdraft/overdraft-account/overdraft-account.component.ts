...
@Component({
  selector: 'app-overdraft-account',
  templateUrl: './overdraft-account.component.html',
  styleUrls: ['./overdraft-account.component.css']
})
export class OverdraftAccountComponent implements OnInit {
  displayedColumns: string[] = ['id', 'name', 'phone', 'guarantorName', 'guarantorPhone', 'created', 'star'];
  ...
  edit(row) {
    this.data.overdraftStorage = row;
  }
}
